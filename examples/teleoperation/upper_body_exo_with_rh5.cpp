...
int main(){
    ...
    std::vector<RobotModelConfig> model_config;
    RobotModelConfig conf_exo;
    conf_exo.file = "../../../examples/teleoperation/urdf/recupera_exo.urdf";

    RobotModelConfig conf_rh5;
    conf_rh5.file = "../../../examples/teleoperation/urdf/rh5.urdf";
    conf_rh5.hook = "root_link_upper_body_exo";
    conf_rh5.initial_pose.position.setZero();
    conf_rh5.initial_pose.orientation.setIdentity();

    model_config.push_back(conf_exo);
    model_config.push_back(conf_rh5);
