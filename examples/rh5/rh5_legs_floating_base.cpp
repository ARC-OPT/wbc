...
int main(){
    ...
    RobotModelConfig config("../../../models/rh5/urdf/rh5_legs.urdf",
    ...
    robot_model_hyrodyn.load_robotmodel("../../../models/rh5/urdf/rh5_legs_floating_base.urdf", "../../../models/rh5/hyrodyn/rh5_legs_floating_base.yml");
