...
VelocityScene::VelocityScene(std::shared_ptr<RobotModelRBDL> robot_model, std::shared_ptr<HierarchicalLSSolver> solver) :
    wbc::VelocityScene(robot_model, solver){
}
VelocityScene::VelocityScene(std::shared_ptr<RobotModelRBDL> robot_model, std::shared_ptr<QPOASESSolver> solver) :
    wbc::VelocityScene(robot_model, solver){
}
...
VelocitySceneQuadraticCost::VelocitySceneQuadraticCost(std::shared_ptr<RobotModelRBDL> robot_model, std::shared_ptr<QPOASESSolver> solver) :
...
AccelerationSceneTSID::AccelerationSceneTSID(std::shared_ptr<RobotModelRBDL> robot_model, std::shared_ptr<QPOASESSolver> solver) :
...
BOOST_PYTHON_MODULE(scenes){
    ...
    py::class_<wbc_py::VelocityScene>("VelocityScene", py::init<std::shared_ptr<wbc_py::RobotModelRBDL>, std::shared_ptr<wbc_py::QPOASESSolver>>())
            .def(py::init<std::shared_ptr<wbc_py::RobotModelRBDL>,std::shared_ptr<wbc_py::HierarchicalLSSolver>>())
    ...
    py::class_<wbc_py::VelocitySceneQuadraticCost>("VelocitySceneQuadraticCost", py::init<std::shared_ptr<wbc_py::RobotModelRBDL>, std::shared_ptr<wbc_py::QPOASESSolver>>())
    ...
    py::class_<wbc_py::AccelerationSceneTSID>("AccelerationSceneTSID", py::init<std::shared_ptr<wbc_py::RobotModelRBDL>, std::shared_ptr<wbc_py::QPOASESSolver>>())
