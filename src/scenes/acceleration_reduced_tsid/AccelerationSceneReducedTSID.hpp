...
public:
    AccelerationSceneReducedTSID(RobotModelPtr robot_model, QPSolverPtr solver, const double dt, uint dim_contact = 3, double friction_cone_weight = 1.0, double friction_margin = 0.0);
