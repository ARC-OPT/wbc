...
protected:
    ...
    struct Pose{
        Pose(){needs_recompute = true;}
        bool needs_recompute;
        types::Pose data;
    };
    struct Twist{
        Twist(){needs_recompute = true;}
        bool needs_recompute;
        types::Twist data;
    };
    struct SpatialAcceleration{
        SpatialAcceleration(){needs_recompute = true;}
        bool needs_recompute;
        types::SpatialAcceleration data;
    };
    struct Matrix{
        Matrix(){needs_recompute = true;}
        bool needs_recompute;
        Eigen::MatrixXd data;
    };
    struct Vector{
        Vector(){needs_recompute = true;}
        bool needs_recompute;
        Eigen::VectorXd data;
    };
    struct RigidBodyState{
        RigidBodyState(){needs_recompute = true;}
        bool needs_recompute;
